            ...
            <div style={{
              ...
              {[
                ...
                <div key={i} style={{
                  ...
                  <p style={{ color: 'rgba(253,250,245,0.2)', fontSize: '0.65rem', letterSpacing: '0.15em', textTransform: 'uppercase' }}>
                    Photo Placeholder
                  </p>
                  <p style={{ color: 'rgba(253,250,245,0.4)', fontSize: '0.8rem', textAlign: 'center' }}>
                    {label}
                  </p>
                </div>
              ))}
