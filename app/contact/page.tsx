      ...
      <main style={{ backgroundColor: '#f5f0e8', minHeight: '100vh' }}>
        ...
        <div className="container" style={{ padding: '5rem 2rem' }}>
          <div style={{
                ...
                <div key={i} style={{
                  ...
                  <div>
                    <p style={{
                      ...
                      color: '#c4622d', marginBottom: '0.3rem',
                    }}>{item.label}</p>
                    {item.link ? (
                      <a href={item.link} target="_blank" rel="noopener noreferrer" style={{
                        fontSize: '0.9rem', color: '#2d2926', textDecoration: 'none',
                ...
                <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                  {[
                    ...
                    <a key={i} href={s.url} target="_blank" rel="noopener noreferrer" style={{
                      ...
                      color: '#6b6460', textDecoration: 'none',
            ...
            {/* Right Form */}
            <div style={{
              backgroundColor: '#fff', padding: '3rem',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                  ...
                  {[
                    ...
                    <div key={field.name}>
                      <label style={{
                        ...
                        letterSpacing: '0.15em', textTransform: 'uppercase',
                        color: '#6b6460', marginBottom: '0.5rem',
                      }}>{field.label}</label>
                      <input
                        ...
                        style={{
                          ...
                          backgroundColor: '#fdfaf5', fontSize: '0.9rem',
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  <div>
                    ...
                    <input
                      type="tel" name="phone" placeholder="(310) 000-0000"
                ...
                <p style={{
                  fontSize: '0.75rem', color: '#6b6460',
                  textAlign: 'center', lineHeight: '1.6',
                }}>
                  Clicking send will open your email app with all details pre-filled and send directly to Ethan.
                </p>
              </div>
            </div>
          </div>
